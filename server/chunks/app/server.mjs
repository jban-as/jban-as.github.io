import { version, toRef, isRef, getCurrentInstance, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, inject, defineAsyncComponent, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8c9eeee4.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-429b0782.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-615fb269.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRouter as a, useHead as b, createError as c, entry$1 as default, navigateTo as n, useState as u };
